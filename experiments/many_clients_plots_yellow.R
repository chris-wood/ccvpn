...
png("many_throughput_10240.png")
barplot(cex.lab=1.5, cex.axis=1.5, cex.main=2.0, cex.sub=2.0,8*(y1)/1000000,names=c("10","50","100","200","400","800"),xlab="Number of consumers",ylab="Sum of total data rate received by all consumers [mbps]", col="darkgreen",ylim=c(0,10+max(8*(y1)/1000000,8*(y2)/1000000)),space=1)
par(new = TRUE)
barplot(cex.lab=1.5, cex.axis=1.5, cex.main=2.0, cex.sub=2.0,8*(y2)/1000000, col="yellow",space=1.5,ylim=c(0,10+max(8*(y1)/1000000,8*(y2)/1000000)))
