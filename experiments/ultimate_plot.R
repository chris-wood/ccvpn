...
SYMM = 8*c(mean(sk50),mean(sk100),mean(sk150),mean(sk200),mean(sk250),mean(sk300))/1000000
PKE = 8*c(mean(pk50),mean(pk100),mean(pk150),mean(pk200),mean(pk250),mean(pk300))/1000000
...
CI1 = 1.64*8*c(errf(sk50),errf(sk100),errf(sk150),errf(sk200),errf(sk250),errf(sk300))/1000000
CI2 = 1.64*8*c(errf(pk50),errf(pk100),errf(pk150),errf(pk200),errf(pk250),errf(pk300))/1000000
