...
\begin{figure}[]
\centering
  \subfigure[Throughput]{\includegraphics[width=0.49\textwidth]{images/1_1_thput.pdf}\label{1a}}
  \hfil
  \subfigure[Avg. RTT]{\includegraphics[width=0.49\textwidth]{images/1_1_rtt.pdf}\label{1b}}
