...
protocol for building secure and private tunnels in CCN. CCPN allows two namespaces
...
For future work, we plan to implement the CCNxKE protocol from \ref{ccnxke} as a
...
include video streaming and large-scale content dissemination applications.
